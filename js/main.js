...
class Circle {
  constructor(x, y, radius, color, text, backcolor, hasBorder = true) {
    this.posX = x;
    this.posY = y;
    this.radius = radius;
    this.color = color;
...
// Objeto con posición aleatoria dentro de los límites de canvasRandom sin borde
...
let miCirculoRandom = new Circle(randomX, randomY, randomRadius, "green", "Tec", "rgb(83, 186, 52)", false);
miCirculoRandom.draw(ctxRandom);

// Múltiples objetos dentro de los límites de canvasMultiple
let arrayCircle = [];
